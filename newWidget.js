    ...
    return function(e) {
        ...
        t.default = class {
            ...
            parseAttributes(e) {
                const t = e.getAttribute("server") || "299881420891881473",
                    ...
                    r = `${e.getAttribute("shard")||"https://widgetbot.io"}/channels/${t}${n?` / $ {
                        n
                    }
                `:""}/?api=${this.id}`, o = e.getAttribute("width"), i = e.getAttribute("height");
        ...
        var i = function(e) {
            function t(t) {
                ...
                }, Object.assign(n, t), window.addEventListener("message", n.socketEvent.bind(n)), n
            }
            return o(t, e), t.prototype.emit = function(e, t) {
                ...
                this.iframe.contentWindow && this.iframe.contentWindow.postMessage(n, "*")
            }, t
        }(n(0).default);
        t.default = i
    }, function(e, t, n) {
        ...
        var i = function(e) {
            ...
            return o(t, e), t.prototype.emit = function(e, t) {
                ...
                window.parent.postMessage(n, this.targetOrigin)
            }, t
        }(n(0).default);
        t.default = i
    }, function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            return e
        }), t.applyStyles = ((e, t) => Object.keys(t).forEach(n => e.style[n] = t[n])), t.generateUUID = function() {
        ...
        e.exports = {
            ...
            main: "umd/@widgetbot/html-embed.js",
